    ...
    <KidShell onExit={onExit} points={phase === 'won' ? starBalance : 0}>
        ...
        <div className="flex w-full max-w-2xl flex-col items-center">
          ...
          {round.kind === 'match' && (
            <>
              ...
              <div className="mt-4 rounded-full bg-white px-4 py-2 text-base font-black text-kid-ink-900 shadow-lg" aria-live="polite">
      ...
      {phase === 'won' && (
        <GameWinScreen
          stars={starsEarned}
          nickname={nickname}
          title={`Opposites ace, ${nickname}!`}
          message={`You found ${ROUNDS_PER_GAME} rounds of opposites`}
          stickerId="opposites-ace"
