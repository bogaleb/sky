...
const QUEST_POOL: QuestDef[] = [
  ...
  { id: 'sentence_game', title: 'Sentence Scribe', detail: 'Build super sentences in Sentence Studio', goal: 1, unit: 'session', stars: 12 },
  { id: 'measure_game', title: 'Measure Master', detail: 'Measure everything in Measure Meadow', goal: 1, unit: 'session', stars: 12 },
  { id: 'opposites_game', title: 'Opposites Ace', detail: 'Match opposites in the Attic', goal: 1, unit: 'session', stars: 12 },
